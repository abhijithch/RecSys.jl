...
function gatherItemMatrix(remoteRefOfItemMatrix::Array, noOfWorkers)	
 ...
 function findU(remoteRefOfTraningDataByRow::RemoteRef, remoteRefOfItemMatrix::Array, noOfWorkers, noOfUsers)												   
 ...
 function findM(remoteRefOfTraningDataByColumn::RemoteRef, remoteRefOfUserMatrix::Array, noOfWorkers, noOfUsers)				
